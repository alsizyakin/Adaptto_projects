...
#include "ideal_source_Motor_new2_cf48dd25_49_ds_dxy_p.h"
...
int32_T ideal_source_Motor_new2_cf48dd25_49_ds_dxy_p ( const NeDynamicSystem
* sys , const NeDynamicSystemInput * t1 , NeDsMethodOutput * out ) { static
int32_T _cg_const_1 [ 10 ] = { 0 , 1 , 2 , 2 , 2 , 2 , 3 , 4 , 5 , 6 } ;
static int32_T _cg_const_2 [ 6 ] = { 1 , 0 , 3 , 4 , 5 , 2 } ; ( void ) t1 ;
out -> mDXY_P . mNumCol = 9UL ; out -> mDXY_P . mNumRow = 9UL ; out -> mDXY_P
...
_cg_const_1 [ 9 ] ; out -> mDXY_P . mIr [ 0 ] = _cg_const_2 [ 0 ] ; out ->
