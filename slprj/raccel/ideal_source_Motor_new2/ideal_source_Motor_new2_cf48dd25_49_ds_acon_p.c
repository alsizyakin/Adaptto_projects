...
#include "ideal_source_Motor_new2_cf48dd25_49_ds_acon_p.h"
...
int32_T ideal_source_Motor_new2_cf48dd25_49_ds_acon_p ( const NeDynamicSystem
* sys , const NeDynamicSystemInput * t1 , NeDsMethodOutput * out ) { static
int32_T _cg_const_1 [ 10 ] = { 0 , 2 , 2 , 2 , 2 , 2 , 3 , 4 , 5 , 7 } ;
static int32_T _cg_const_2 [ 7 ] = { 0 , 2 , 6 , 7 , 8 , 1 , 5 } ; ( void )
t1 ; out -> mACON_P . mNumCol = 9UL ; out -> mACON_P . mNumRow = 9UL ; out ->
