...
#endif
#include "nesl_rtw.h"
#include "ideal_source_Motor_new2_cf48dd25_49.h"
#include "ideal_source_Motor_new2_cf48dd25_1_gateway.h"
void ideal_source_Motor_new2_cf48dd25_1_gateway ( void ) { NeModelParameters
modelparams = { ( enum NeSolverTypeTag ) 0 , 0.001 , 0.001 , 0.001 , TRUE ,
FALSE , ( enum NeModifyAbsTolTag ) 1 , 0.001 , 0.0 , FALSE , FALSE , FALSE ,
( enum SscLoggingSettingTag ) 0 , 685375248.0 , FALSE , FALSE , FALSE } ;
...
, 3U } , } ; outputparameters = outputparameters_init ; numOutputs = sizeof ( outputparameters_init ) / sizeof ( outputparameters_init [ 0 ] ) ; } ideal_source_Motor_new2_cf48dd25_49_dae ( & dae , & modelparams , & solverparams ) ; nesl_register_simulator_group ( "ideal_source_Motor_new2/Solver Configuration_1" , 1 , & dae , & solverparams , & modelparams , numOutputs , outputparameters , 1 , rtpDaes , 0 , rtwLogDaes , 0 , solverHitDaes ) ; }
