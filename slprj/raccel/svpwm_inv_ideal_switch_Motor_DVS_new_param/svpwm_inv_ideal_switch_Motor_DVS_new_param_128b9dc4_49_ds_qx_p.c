...
#include "svpwm_inv_ideal_switch_Motor_DVS_new_param_128b9dc4_49_ds_qx_p.h"
...
int32_T svpwm_inv_ideal_switch_Motor_DVS_new_param_128b9dc4_49_ds_qx_p ( const
NeDynamicSystem * sys , const NeDynamicSystemInput * t1 , NeDsMethodOutput *
out ) { static int32_T _cg_const_2 [ 158 ] = { 1 , 7 , 8 , 20 , 21 , 22 , 23
, 24 , 25 , 26 , 30 , 31 , 1 , 7 , 8 , 20 , 21 , 22 , 23 , 24 , 25 , 26 , 30
, 31 , 1 , 7 , 8 , 20 , 21 , 22 , 23 , 24 , 25 , 26 , 30 , 31 , 18 , 19 , 18
, 19 , 1 , 7 , 8 , 20 , 21 , 22 , 23 , 24 , 25 , 26 , 1 , 7 , 8 , 20 , 21 ,
22 , 23 , 24 , 25 , 26 , 28 , 30 , 31 , 1 , 7 , 8 , 20 , 21 , 22 , 23 , 24 ,
25 , 26 , 28 , 30 , 31 , 1 , 7 , 8 , 20 , 21 , 22 , 23 , 24 , 25 , 26 , 30 ,
31 , 34 , 1 , 7 , 8 , 20 , 21 , 22 , 23 , 24 , 25 , 26 , 30 , 31 , 34 , 1 , 7
, 8 , 20 , 21 , 22 , 23 , 24 , 25 , 26 , 28 , 30 , 31 , 1 , 7 , 8 , 20 , 21 ,
22 , 23 , 24 , 25 , 26 , 30 , 31 , 34 , 21 , 22 , 25 , 28 , 1 , 7 , 8 , 21 ,
22 , 23 , 24 , 25 , 26 , 30 , 31 , 1 , 7 , 8 , 21 , 22 , 23 , 24 , 25 , 26 ,
30 , 31 , 23 , 24 , 26 , 34 } ; static int32_T _cg_const_1 [ 38 ] = { 0 , 0 ,
12 , 12 , 12 , 12 , 12 , 12 , 24 , 36 , 36 , 36 , 36 , 36 , 36 , 36 , 36 , 36
, 36 , 38 , 40 , 50 , 63 , 76 , 89 , 102 , 115 , 128 , 128 , 132 , 132 , 143
, 154 , 154 , 154 , 158 , 158 , 158 } ; int32_T i1 ; ( void ) t1 ; out ->
mQX_P . mNumCol = 37UL ; out -> mQX_P . mNumRow = 37UL ; out -> mQX_P . mJc [
0 ] = _cg_const_1 [ 0 ] ; out -> mQX_P . mJc [ 1 ] = _cg_const_1 [ 1 ] ; out
...
_cg_const_1 [ 36 ] ; out -> mQX_P . mJc [ 37 ] = _cg_const_1 [ 37 ] ; for ( i1
= 0 ; i1 < 158 ; i1 ++ ) { out -> mQX_P . mIr [ i1 ] = _cg_const_2 [ i1 ] ; }
