...
#endif
#include "nesl_rtw.h"
#include "svpwm_inv_ideal_switch_Motor_DVS_new_param_128b9dc4_49.h"
#include "svpwm_inv_ideal_switch_Motor_DVS_new_param_128b9dc4_1_gateway.h"
void svpwm_inv_ideal_switch_Motor_DVS_new_param_128b9dc4_1_gateway ( void ) {
...
FALSE , FALSE , ( enum SscLoggingSettingTag ) 0 , 691705706.0 , FALSE , FALSE
...
svpwm_inv_ideal_switch_Motor_DVS_new_param_128b9dc4_49_dae ( & dae , &
modelparams , & solverparams ) ; nesl_register_simulator_group ( "svpwm_inv_ideal_switch_Motor_DVS_new_param/Solver Configuration1_1" , 1 , & dae , & solverparams , & modelparams , numOutputs , outputparameters , 1 , rtpDaes , 0 , rtwLogDaes , 0 , solverHitDaes ) ; }
