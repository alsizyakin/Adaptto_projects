...
#include "svpwm_inv_ideal_switch_Motor_DVS_new_param_128b9dc4_49_ds_tdxy_p.h"
...
int32_T svpwm_inv_ideal_switch_Motor_DVS_new_param_128b9dc4_49_ds_tdxy_p ( const
NeDynamicSystem * sys , const NeDynamicSystemInput * t1 , NeDsMethodOutput *
out ) { static int32_T _cg_const_1 [ 38 ] = { 0 , 1 , 4 , 5 , 6 , 6 , 6 , 6 ,
9 , 12 , 12 , 14 , 14 , 14 , 16 , 16 , 16 , 18 , 18 , 18 , 19 , 19 , 19 , 19
, 19 , 19 , 20 , 21 , 21 , 21 , 21 , 21 , 22 , 22 , 22 , 22 , 22 , 22 } ;
static int32_T _cg_const_2 [ 22 ] = { 12 , 1 , 2 , 12 , 4 , 3 , 0 , 2 , 12 ,
1 , 2 , 12 , 9 , 11 , 9 , 10 , 10 , 11 , 5 , 7 , 8 , 6 } ; ( void ) t1 ; out
-> mTDXY_P . mNumCol = 37UL ; out -> mTDXY_P . mNumRow = 13UL ; out ->
...
_cg_const_1 [ 37 ] ; out -> mTDXY_P . mIr [ 0 ] = _cg_const_2 [ 0 ] ; out ->
...
_cg_const_2 [ 20 ] ; out -> mTDXY_P . mIr [ 21 ] = _cg_const_2 [ 21 ] ; ( void
