...
#include "svpwm_inv_ideal_switch_Motor_DVS_new_param_128b9dc4_49_ds_ic.h"
...
int32_T svpwm_inv_ideal_switch_Motor_DVS_new_param_128b9dc4_49_ds_ic ( const
NeDynamicSystem * sys , const NeDynamicSystemInput * t1 , NeDsMethodOutput *
out ) { out -> mIC . mX [ 0UL ] = t1 -> mP_R . mX [ 0UL ] ; out -> mIC . mX [
1UL ] = 0.0 ; out -> mIC . mX [ 2UL ] = 0.0 ; out -> mIC . mX [ 3UL ] = 0.0 ;
out -> mIC . mX [ 4UL ] = t1 -> mP_R . mX [ 1UL ] * 0.017453292519943295 ;
out -> mIC . mX [ 5UL ] = t1 -> mP_R . mX [ 2UL ] ; out -> mIC . mX [ 6UL ] =
t1 -> mP_R . mX [ 3UL ] ; out -> mIC . mX [ 7UL ] = 0.0 ; out -> mIC . mX [
...
-> mIC . mX [ 34UL ] = 0.0 ; out -> mIC . mX [ 35UL ] = 0.0 ; out -> mIC . mX
[ 36UL ] = 0.0 ; ( void ) sys ; ( void ) out ; return 0 ; }
