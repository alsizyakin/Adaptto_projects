...
#include "svpwm_inv_ideal_switch_Motor_DVS_new_param_128b9dc4_49_ds_acon_p.h"
...
int32_T svpwm_inv_ideal_switch_Motor_DVS_new_param_128b9dc4_49_ds_acon_p ( const
NeDynamicSystem * sys , const NeDynamicSystemInput * t1 , NeDsMethodOutput *
out ) { static int32_T _cg_const_1 [ 38 ] = { 0 , 2 , 4 , 7 , 7 , 7 , 7 , 7 ,
9 , 11 , 11 , 12 , 12 , 12 , 13 , 13 , 13 , 14 , 14 , 15 , 16 , 16 , 16 , 16
, 16 , 16 , 18 , 20 , 20 , 20 , 20 , 20 , 22 , 22 , 22 , 22 , 22 , 22 } ;
static int32_T _cg_const_2 [ 22 ] = { 0 , 36 , 2 , 36 , 1 , 4 , 13 , 0 , 36 ,
2 , 36 , 35 , 34 , 33 , 3 , 32 , 34 , 36 , 35 , 36 , 33 , 36 } ; ( void ) t1
; out -> mACON_P . mNumCol = 37UL ; out -> mACON_P . mNumRow = 37UL ; out ->
...
_cg_const_1 [ 37 ] ; out -> mACON_P . mIr [ 0 ] = _cg_const_2 [ 0 ] ; out ->
...
_cg_const_2 [ 20 ] ; out -> mACON_P . mIr [ 21 ] = _cg_const_2 [ 21 ] ; ( void
