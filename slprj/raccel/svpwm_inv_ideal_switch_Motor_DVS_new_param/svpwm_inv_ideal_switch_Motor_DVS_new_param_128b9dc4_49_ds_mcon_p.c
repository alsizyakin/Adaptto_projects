...
#include "svpwm_inv_ideal_switch_Motor_DVS_new_param_128b9dc4_49_ds_mcon_p.h"
...
int32_T svpwm_inv_ideal_switch_Motor_DVS_new_param_128b9dc4_49_ds_mcon_p ( const
NeDynamicSystem * sys , const NeDynamicSystemInput * t1 , NeDsMethodOutput *
out ) { static int32_T _cg_const_1 [ 38 ] = { 0 , 1 , 2 , 3 , 4 , 5 , 6 , 7 ,
7 , 7 , 7 , 7 , 7 , 7 , 7 , 7 , 7 , 7 , 7 , 7 , 7 , 7 , 7 , 7 , 7 , 7 , 7 , 7
, 7 , 7 , 7 , 7 , 7 , 7 , 7 , 7 , 7 , 7 } ; static int32_T _cg_const_2 [ 7 ]
= { 0 , 2 , 3 , 1 , 4 , 5 , 6 } ; ( void ) t1 ; out -> mMCON_P . mNumCol =
37UL ; out -> mMCON_P . mNumRow = 37UL ; out -> mMCON_P . mJc [ 0 ] =
_cg_const_1 [ 0 ] ; out -> mMCON_P . mJc [ 1 ] = _cg_const_1 [ 1 ] ; out ->
mMCON_P . mJc [ 2 ] = _cg_const_1 [ 2 ] ; out -> mMCON_P . mJc [ 3 ] =
_cg_const_1 [ 3 ] ; out -> mMCON_P . mJc [ 4 ] = _cg_const_1 [ 4 ] ; out ->
mMCON_P . mJc [ 5 ] = _cg_const_1 [ 5 ] ; out -> mMCON_P . mJc [ 6 ] =
