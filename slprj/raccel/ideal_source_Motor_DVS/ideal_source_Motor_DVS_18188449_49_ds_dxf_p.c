...
#include "ideal_source_Motor_DVS_18188449_49_ds_dxf_p.h"
...
int32_T ideal_source_Motor_DVS_18188449_49_ds_dxf_p ( const NeDynamicSystem *
sys , const NeDynamicSystemInput * t1 , NeDsMethodOutput * out ) { static
int32_T _cg_const_2 [ 21 ] = { 2 , 3 , 5 , 6 , 7 , 3 , 4 , 5 , 6 , 7 , 2 , 4
, 5 , 6 , 7 , 2 , 3 , 2 , 3 , 2 , 3 } ; static int32_T _cg_const_1 [ 9 ] = {
0 , 0 , 5 , 10 , 15 , 17 , 19 , 21 , 21 } ; ( void ) t1 ; out -> mDXF_P .
mNumCol = 8UL ; out -> mDXF_P . mNumRow = 8UL ; out -> mDXF_P . mJc [ 0 ] =
...
mDXF_P . mJc [ 8 ] = _cg_const_1 [ 8 ] ; out -> mDXF_P . mIr [ 0 ] =
...
mDXF_P . mIr [ 20 ] = _cg_const_2 [ 20 ] ; ( void ) sys ; ( void ) out ;
return 0 ; }
