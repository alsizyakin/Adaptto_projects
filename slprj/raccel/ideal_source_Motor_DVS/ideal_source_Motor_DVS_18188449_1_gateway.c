...
#endif
#include "nesl_rtw.h"
#include "ideal_source_Motor_DVS_18188449_49.h"
...
, 3U } , { 0U , 4U } , } ; outputparameters = outputparameters_init ;
numOutputs = sizeof ( outputparameters_init ) / sizeof ( outputparameters_init
[ 0 ] ) ; } ideal_source_Motor_DVS_18188449_49_dae ( & dae , & modelparams ,
& solverparams ) ; nesl_register_simulator_group ( "ideal_source_Motor_DVS/Solver Configuration_1" , 1 , & dae , & solverparams , & modelparams , numOutputs , outputparameters , 1 , rtpDaes , 0 , rtwLogDaes , 0 , solverHitDaes ) ; }
