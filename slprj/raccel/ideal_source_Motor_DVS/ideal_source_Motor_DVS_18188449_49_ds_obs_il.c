...
#include "ideal_source_Motor_DVS_18188449_49_ds_obs_il.h"
...
int32_T ideal_source_Motor_DVS_18188449_49_ds_obs_il ( const NeDynamicSystem
* sys , const NeDynamicSystemInput * t1 , NeDsMethodOutput * out ) { static
boolean_T _cg_const_1 [ 115 ] = { true , true , false , false , false , true
...
, false , false , false , false , false , false } ; int32_T i ; ( void ) t1 ;
for ( i = 0 ; i < 115 ; i ++ ) { out -> mOBS_IL . mX [ i ] = _cg_const_1 [ i
