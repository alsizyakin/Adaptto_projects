...
#include "ideal_source_Motor_2_149a6a2f_49_ds_obs_all.h"
...
int32_T ideal_source_Motor_2_149a6a2f_49_ds_obs_all ( const NeDynamicSystem *
sys , const NeDynamicSystemInput * t20 , NeDsMethodOutput * out ) { real_T
Subsystem2_Voltage_Sensor1_V ; real_T t17 ; real_T t18 ; out -> mOBS_ALL . mX
[ 31UL ] = t20 -> mU . mX [ 0UL ] ; out -> mOBS_ALL . mX [ 32UL ] = - t20 ->
mU . mX [ 0UL ] ; out -> mOBS_ALL . mX [ 33UL ] = - t20 -> mX . mX [ 0UL ] ;
out -> mOBS_ALL . mX [ 36UL ] = - t20 -> mX . mX [ 8UL ] + t20 -> mU . mX [
0UL ] ; out -> mOBS_ALL . mX [ 68UL ] = - t20 -> mX . mX [ 8UL ] ;
Subsystem2_Voltage_Sensor1_V = t20 -> mU . mX [ 1UL ] - t20 -> mU . mX [ 2UL
] ; t17 = t20 -> mU . mX [ 2UL ] - t20 -> mU . mX [ 3UL ] ; t18 = t20 -> mU .
mX [ 3UL ] - t20 -> mU . mX [ 1UL ] ; out -> mOBS_ALL . mX [ 0UL ] = t20 ->
mX . mX [ 5UL ] ; out -> mOBS_ALL . mX [ 1UL ] = 0.0 ; out -> mOBS_ALL . mX [
2UL ] = t20 -> mU . mX [ 1UL ] ; out -> mOBS_ALL . mX [ 3UL ] = t20 -> mU .
mX [ 1UL ] ; out -> mOBS_ALL . mX [ 4UL ] = t20 -> mU . mX [ 1UL ] ; out ->
mOBS_ALL . mX [ 5UL ] = t20 -> mX . mX [ 6UL ] ; out -> mOBS_ALL . mX [ 6UL ]
= 0.0 ; out -> mOBS_ALL . mX [ 7UL ] = t20 -> mU . mX [ 2UL ] ; out ->
mOBS_ALL . mX [ 8UL ] = t20 -> mU . mX [ 2UL ] ; out -> mOBS_ALL . mX [ 9UL ]
= t20 -> mU . mX [ 2UL ] ; out -> mOBS_ALL . mX [ 10UL ] = t20 -> mX . mX [
7UL ] ; out -> mOBS_ALL . mX [ 11UL ] = 0.0 ; out -> mOBS_ALL . mX [ 12UL ] =
t20 -> mU . mX [ 3UL ] ; out -> mOBS_ALL . mX [ 13UL ] = t20 -> mU . mX [ 3UL
] ; out -> mOBS_ALL . mX [ 14UL ] = t20 -> mU . mX [ 3UL ] ; out -> mOBS_ALL
. mX [ 15UL ] = 0.0 ; out -> mOBS_ALL . mX [ 16UL ] = t20 -> mX . mX [ 1UL ]
; out -> mOBS_ALL . mX [ 17UL ] = 0.0 ; out -> mOBS_ALL . mX [ 18UL ] = t20
-> mX . mX [ 0UL ] ; out -> mOBS_ALL . mX [ 19UL ] = t20 -> mX . mX [ 0UL ] ;
out -> mOBS_ALL . mX [ 20UL ] = 0.0 ; out -> mOBS_ALL . mX [ 21UL ] = t20 ->
mX . mX [ 1UL ] ; out -> mOBS_ALL . mX [ 22UL ] = t20 -> mX . mX [ 1UL ] ;
out -> mOBS_ALL . mX [ 23UL ] = t20 -> mX . mX [ 0UL ] ; out -> mOBS_ALL . mX
[ 24UL ] = t20 -> mX . mX [ 0UL ] ; out -> mOBS_ALL . mX [ 25UL ] = t20 -> mX
. mX [ 0UL ] ; out -> mOBS_ALL . mX [ 26UL ] = - t20 -> mX . mX [ 8UL ] ; out
-> mOBS_ALL . mX [ 27UL ] = - t20 -> mX . mX [ 8UL ] ; out -> mOBS_ALL . mX [
28UL ] = - t20 -> mX . mX [ 8UL ] ; out -> mOBS_ALL . mX [ 29UL ] = 0.0 ; out
-> mOBS_ALL . mX [ 30UL ] = t20 -> mX . mX [ 0UL ] ; out -> mOBS_ALL . mX [
34UL ] = t20 -> mX . mX [ 0UL ] ; out -> mOBS_ALL . mX [ 35UL ] = t20 -> mX .
mX [ 0UL ] ; out -> mOBS_ALL . mX [ 37UL ] = t20 -> mX . mX [ 0UL ] ; out ->
mOBS_ALL . mX [ 38UL ] = 0.0 ; out -> mOBS_ALL . mX [ 39UL ] = 0.0 ; out ->
mOBS_ALL . mX [ 40UL ] = 0.0 ; out -> mOBS_ALL . mX [ 41UL ] = 0.0 ; out ->
mOBS_ALL . mX [ 42UL ] = 0.0 ; out -> mOBS_ALL . mX [ 43UL ] = 0.0 ; out ->
mOBS_ALL . mX [ 44UL ] = 0.0 ; out -> mOBS_ALL . mX [ 45UL ] = 0.0 ; out ->
mOBS_ALL . mX [ 46UL ] = 0.0 ; out -> mOBS_ALL . mX [ 47UL ] = 0.0 ; out ->
mOBS_ALL . mX [ 48UL ] = 0.0 ; out -> mOBS_ALL . mX [ 49UL ] = 0.0 ; out ->
mOBS_ALL . mX [ 50UL ] = 0.0 ; out -> mOBS_ALL . mX [ 51UL ] = t20 -> mX . mX
[ 0UL ] ; out -> mOBS_ALL . mX [ 52UL ] = 0.187 ; out -> mOBS_ALL . mX [ 53UL
] = 0.187 ; out -> mOBS_ALL . mX [ 54UL ] = 0.187 ; out -> mOBS_ALL . mX [
...
Subsystem2_Voltage_Sensor1_V ; out -> mOBS_ALL . mX [ 108UL ] = t20 -> mU .
...
Subsystem2_Voltage_Sensor1_V ; out -> mOBS_ALL . mX [ 115UL ] = t18 ; out ->
