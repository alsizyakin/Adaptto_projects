...
out ) { static int32_T _cg_const_1 [ 36 ] = { 0 , 2 , 4 , 4 , 4 , 4 , 4 , 6 ,
8 , 8 , 9 , 9 , 9 , 10 , 10 , 10 , 11 , 11 , 11 , 11 , 11 , 11 , 11 , 13 , 15
, 15 , 15 , 15 , 15 , 17 , 17 , 17 , 17 , 17 , 17 , 18 } ; static int32_T
_cg_const_2 [ 18 ] = { 0 , 34 , 2 , 34 , 0 , 34 , 2 , 34 , 33 , 32 , 31 , 32
, 34 , 33 , 34 , 31 , 34 , 30 } ; ( void ) t1 ; out -> mACON_P . mNumCol =
35UL ; out -> mACON_P . mNumRow = 35UL ; out -> mACON_P . mJc [ 0 ] =
...
-> mACON_P . mJc [ 35 ] = _cg_const_1 [ 35 ] ; out -> mACON_P . mIr [ 0 ] =
...
-> mACON_P . mIr [ 17 ] = _cg_const_2 [ 17 ] ; ( void ) sys ; ( void ) out ;
return 0 ; }
