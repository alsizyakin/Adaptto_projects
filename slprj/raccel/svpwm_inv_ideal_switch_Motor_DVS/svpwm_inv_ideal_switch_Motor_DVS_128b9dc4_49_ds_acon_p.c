...
#include "svpwm_inv_ideal_switch_Motor_DVS_128b9dc4_49_ds_acon_p.h"
...
int32_T svpwm_inv_ideal_switch_Motor_DVS_128b9dc4_49_ds_acon_p ( const
NeDynamicSystem * sys , const NeDynamicSystemInput * t1 , NeDsMethodOutput *
out ) { static int32_T _cg_const_1 [ 37 ] = { 0 , 2 , 4 , 6 , 6 , 6 , 6 , 6 ,
8 , 10 , 10 , 11 , 11 , 11 , 12 , 12 , 12 , 13 , 13 , 13 , 13 , 13 , 13 , 13
, 15 , 17 , 17 , 17 , 17 , 17 , 19 , 19 , 19 , 19 , 19 , 19 , 21 } ; static
int32_T _cg_const_2 [ 21 ] = { 0 , 35 , 2 , 35 , 1 , 4 , 0 , 35 , 2 , 35 , 34
, 33 , 32 , 33 , 35 , 34 , 35 , 32 , 35 , 3 , 31 } ; ( void ) t1 ; out ->
mACON_P . mNumCol = 36UL ; out -> mACON_P . mNumRow = 36UL ; out -> mACON_P .
mJc [ 0 ] = _cg_const_1 [ 0 ] ; out -> mACON_P . mJc [ 1 ] = _cg_const_1 [ 1
] ; out -> mACON_P . mJc [ 2 ] = _cg_const_1 [ 2 ] ; out -> mACON_P . mJc [ 3
...
_cg_const_1 [ 36 ] ; out -> mACON_P . mIr [ 0 ] = _cg_const_2 [ 0 ] ; out ->
...
_cg_const_2 [ 20 ] ; ( void ) sys ; ( void ) out ; return 0 ; }
