...
#include "ideal_source_Motor_third_part_cf48dd25_49_ds_dxf_p.h"
...
int32_T ideal_source_Motor_third_part_cf48dd25_49_ds_dxf_p ( const
NeDynamicSystem * sys , const NeDynamicSystemInput * t1 , NeDsMethodOutput *
out ) { static int32_T _cg_const_2 [ 23 ] = { 3 , 4 , 3 , 4 , 6 , 7 , 8 , 4 ,
5 , 6 , 7 , 8 , 3 , 5 , 6 , 7 , 8 , 3 , 4 , 3 , 4 , 3 , 4 } ; static int32_T
_cg_const_1 [ 10 ] = { 0 , 2 , 2 , 7 , 12 , 17 , 19 , 21 , 23 , 23 } ; ( void
) t1 ; out -> mDXF_P . mNumCol = 9UL ; out -> mDXF_P . mNumRow = 9UL ; out ->
...
mDXF_P . mJc [ 9 ] = _cg_const_1 [ 9 ] ; out -> mDXF_P . mIr [ 0 ] =
...
_cg_const_2 [ 21 ] ; out -> mDXF_P . mIr [ 22 ] = _cg_const_2 [ 22 ] ; ( void
