...
#include "ideal_source_Motor_third_part_cf48dd25_49_ds_log.h"
...
int32_T ideal_source_Motor_third_part_cf48dd25_49_ds_log ( const
NeDynamicSystem * sys , const NeDynamicSystemInput * t5 , NeDsMethodOutput *
out ) { real_T Subsystem4_Voltage_Sensor1_V ; real_T
Subsystem4_Voltage_Sensor9_V ; real_T t2 ; out -> mLOG . mX [ 24UL ] = t5 ->
mU . mX [ 0UL ] ; out -> mLOG . mX [ 25UL ] = - t5 -> mU . mX [ 0UL ] ; out
-> mLOG . mX [ 26UL ] = - t5 -> mX . mX [ 0UL ] ; out -> mLOG . mX [ 29UL ] =
- t5 -> mX . mX [ 8UL ] + t5 -> mU . mX [ 0UL ] ; out -> mLOG . mX [ 37UL ] =
- t5 -> mX . mX [ 8UL ] ; out -> mLOG . mX [ 43UL ] = ( t5 -> mX . mX [ 5UL ]
* t5 -> mX . mX [ 5UL ] * 1.3000000000000003E-6 + t5 -> mX . mX [ 6UL ] * t5
-> mX . mX [ 6UL ] * 1.3000000000000003E-6 ) + t5 -> mX . mX [ 7UL ] * t5 ->
mX . mX [ 7UL ] * 1.3000000000000003E-6 ; Subsystem4_Voltage_Sensor1_V = t5
-> mU . mX [ 1UL ] - t5 -> mU . mX [ 2UL ] ; t2 = t5 -> mU . mX [ 2UL ] - t5
-> mU . mX [ 3UL ] ; Subsystem4_Voltage_Sensor9_V = t5 -> mU . mX [ 3UL ] -
t5 -> mU . mX [ 1UL ] ; out -> mLOG . mX [ 0UL ] = t5 -> mX . mX [ 5UL ] ;
out -> mLOG . mX [ 1UL ] = t5 -> mU . mX [ 1UL ] ; out -> mLOG . mX [ 2UL ] =
t5 -> mU . mX [ 1UL ] ; out -> mLOG . mX [ 3UL ] = t5 -> mU . mX [ 1UL ] ;
out -> mLOG . mX [ 4UL ] = t5 -> mX . mX [ 6UL ] ; out -> mLOG . mX [ 5UL ] =
t5 -> mU . mX [ 2UL ] ; out -> mLOG . mX [ 6UL ] = t5 -> mU . mX [ 2UL ] ;
out -> mLOG . mX [ 7UL ] = t5 -> mU . mX [ 2UL ] ; out -> mLOG . mX [ 8UL ] =
t5 -> mX . mX [ 7UL ] ; out -> mLOG . mX [ 9UL ] = t5 -> mU . mX [ 3UL ] ;
out -> mLOG . mX [ 10UL ] = t5 -> mU . mX [ 3UL ] ; out -> mLOG . mX [ 11UL ]
