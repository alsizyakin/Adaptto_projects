...
#endif
#include "nesl_rtw.h"
#include "ideal_source_Motor_third_part_cf48dd25_49.h"
#include "ideal_source_Motor_third_part_cf48dd25_1_gateway.h"
void ideal_source_Motor_third_part_cf48dd25_1_gateway ( void ) {
...
FALSE , FALSE , ( enum SscLoggingSettingTag ) 0 , 687895014.0 , FALSE , FALSE
...
outputparameters_init [ ] = { { 0U , 0U } , { 0U , 1U } , { 0U , 2U } , { 0U
, 3U } , } ; outputparameters = outputparameters_init ; numOutputs = sizeof ( outputparameters_init ) / sizeof ( outputparameters_init [ 0 ] ) ; } ideal_source_Motor_third_part_cf48dd25_49_dae ( & dae , & modelparams , & solverparams ) ; nesl_register_simulator_group ( "ideal_source_Motor_third_part/Solver Configuration_1" , 1 , & dae , & solverparams , & modelparams , numOutputs , outputparameters , 1 , rtpDaes , 0 , rtwLogDaes , 0 , solverHitDaes ) ; }
