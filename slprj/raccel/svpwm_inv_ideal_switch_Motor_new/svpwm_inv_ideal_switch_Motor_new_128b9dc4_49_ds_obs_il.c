...
#include "svpwm_inv_ideal_switch_Motor_new_128b9dc4_49_ds_obs_il.h"
...
int32_T svpwm_inv_ideal_switch_Motor_new_128b9dc4_49_ds_obs_il ( const
NeDynamicSystem * sys , const NeDynamicSystemInput * t1 , NeDsMethodOutput *
out ) { static boolean_T _cg_const_1 [ 460 ] = { true , true , true , true ,
...
true , true , true , true , true , true , true , true , true , true , true ,
true , true , true , true , true , true , true , true , true , true , true ,
true , true , true , true } ; int32_T i ; ( void ) t1 ; for ( i = 0 ; i < 460
