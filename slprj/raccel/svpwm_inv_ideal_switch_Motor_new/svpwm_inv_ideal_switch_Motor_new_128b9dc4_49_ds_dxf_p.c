...
#include "svpwm_inv_ideal_switch_Motor_new_128b9dc4_49_ds_dxf_p.h"
...
int32_T svpwm_inv_ideal_switch_Motor_new_128b9dc4_49_ds_dxf_p ( const
NeDynamicSystem * sys , const NeDynamicSystemInput * t1 , NeDsMethodOutput *
out ) { static int32_T _cg_const_2 [ 134 ] = { 13 , 15 , 16 , 18 , 25 , 27 ,
13 , 15 , 16 , 18 , 25 , 27 , 5 , 6 , 5 , 6 , 32 , 33 , 34 , 6 , 31 , 32 , 33
, 34 , 5 , 31 , 32 , 33 , 34 , 13 , 14 , 15 , 16 , 18 , 20 , 25 , 27 , 13 ,
15 , 16 , 18 , 20 , 25 , 27 , 13 , 15 , 16 , 17 , 18 , 23 , 25 , 27 , 13 , 15
, 16 , 18 , 23 , 25 , 27 , 13 , 15 , 16 , 18 , 25 , 26 , 27 , 29 , 13 , 15 ,
16 , 18 , 25 , 27 , 29 , 13 , 15 , 16 , 18 , 25 , 27 , 7 , 5 , 6 , 7 , 25 ,
27 , 28 , 30 , 8 , 9 , 5 , 6 , 9 , 16 , 18 , 22 , 24 , 10 , 11 , 5 , 6 , 11 ,
13 , 15 , 19 , 21 , 12 , 13 , 14 , 16 , 17 , 20 , 21 , 5 , 6 , 20 , 19 , 20 ,
23 , 24 , 5 , 6 , 23 , 22 , 23 , 25 , 26 , 29 , 30 , 5 , 6 , 29 , 28 , 29 } ;
static int32_T _cg_const_1 [ 37 ] = { 0 , 6 , 12 , 14 , 14 , 19 , 24 , 29 ,
37 , 44 , 52 , 59 , 67 , 74 , 80 , 81 , 88 , 89 , 90 , 97 , 98 , 99 , 106 ,
107 , 109 , 111 , 113 , 116 , 118 , 120 , 123 , 125 , 127 , 129 , 132 , 134 ,
134 } ; int32_T i1 ; ( void ) t1 ; out -> mDXF_P . mNumCol = 36UL ; out ->
mDXF_P . mNumRow = 36UL ; out -> mDXF_P . mJc [ 0 ] = _cg_const_1 [ 0 ] ; out
...
_cg_const_1 [ 35 ] ; out -> mDXF_P . mJc [ 36 ] = _cg_const_1 [ 36 ] ; for ( i1
= 0 ; i1 < 134 ; i1 ++ ) { out -> mDXF_P . mIr [ i1 ] = _cg_const_2 [ i1 ] ;
